...
\State \textbf{Class} messageReceiver
    ...
    \State 1. Establish a WebSocket connection
    \State 2. Receive, process and send messages
    \State 3. Handle exceptions
    \EndProcedure
\State \textbf{EndClass}
...
\begin{algorithm}
    ...
    \Else
        \If{previous agent is not self}
            ...
            \EndIf
        \If{agent is not last one AND next agent is not self}
