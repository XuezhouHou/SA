...
As mentioned at the beginning of this chapter, \gls{dt} agent should be completely decoupled from \gls{mas}. 
...
One issue of using \gls{tcp} is that, packets do not arrive one by one but stuck to each other.
This issue can be solved by using delimiter for packets separation.  
