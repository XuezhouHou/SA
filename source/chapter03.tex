...
For the modularizaion purpose, the concentration should be shifted from the general 
\gls{osi} model to the more abstract \gls{tcp/ip} model. 
\begin{figure}[htb]
    ...
    \caption{Snippet of Data Explorer\label{fig: KQL}}
\end{figure}
\subsection{Timing properties of data transfer w.r.t sockets in each layer of \gls{tcp/ip} model}
