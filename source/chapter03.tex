...
At the beginning of this chapter, a former consideration of a 
message-based software architecture based on BMW and Wittenstein use cases 
is explained in section \ref{chap: Meth-Msg-software-architecture}.
After that, to realize the decentralization of \gls{mas}, we divided the general \gls{mas} into 
...
\section{Message-based software architecture with two industrial use cases}
\label{chap: Meth-Msg-software-architecture}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{figures/methodology/Msg-based-Software-Architecture.png}
...
\begin{figure}[htb]
    \centering
\includegraphics[width=\textwidth]{figures/methodology/MAS_Conceptual_Diagram.pdf}
...
\begin{figure}[htbp]
    \centering
\includegraphics[width=0.6\textwidth]{figures/methodology/OSI.pdf}
...
\begin{figure}[htb]
    \centering
\includegraphics[width=0.8\textwidth]{figures/methodology/MessageConceptual.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/methodology/Server-clients-decentralize.pdf}
