...
\begin{landscape}
    ...
    Test case                        & var. value & Trans. Delay (ms) & OWD (ms) & Server Proc. Delay (ms) & Trans. Delay (ms) & OWD (ms) & Server Proc. Delay (ms) \\ \hline
...
\begin{landscape}
    ...
    \resizebox{\columnwidth}{!}{%
    \begin{tabular}{llllllll}
    Test case                     & Client ID  & Trans. Delay (ms) & OWD (ms)    & Server Proc. Delay (ms) & Trans. Delay (ms) & OWD (ms)    & Server Proc. Delay (ms) \\ \hline
    6. Non-priori. string\_msg    & 1-10       & 0.967895          & 0.763061    & 0.204834                & 0.953934          & 0.747598    & 0.206336                \\
    (client: 10,                  & (normal)   &                   &             &                         &                   &             &                         \\
    byte length: 40B,             &            &                   &             &                         &                   &             &                         \\
    Protocol: WebSocket)          &            &                   &             &                         &                   &             &                         \\
    7. Non-priori. json\_msg      & 1-10       & 9.172859          & 3.783451    & 5.389408                & 1.314781          & 1.063232    & 0.251549                \\
    ...
    9. priori.string\_msg         & 1-9        & 115.32263         & 2.788792222 & 112.5338378             & 69.84120556       & 1.788741111 & 68.05246444             \\
    (client: 10,                  & (normal)   &                   &             &                         &                   &             &                         \\
    byte length: 40B,             & 10         & 0.898             & 0.794       & 0.104                   & 0.693             & 0.586       & 0.107                   \\
    Protocol: WebSocket)          & (critical) &                   &             &                         &                   &             &                         \\
    10. priori.string\_msg        & 1-49       & 28.69973245       & 3.090028367 & 25.60970408             & 12.07897857       & 3.435143061 & 8.64383551              \\
    (client: 50,                  & (normal)   &                   &             &                         &                   &             &                         \\
    ...
    Protocol: WebSocket)          & (critical) &                   &             &                         &                   &             &                         \\
    12. priori.json\_msg          & 1-9        & 66.03862127       & 2.546360177 & 63.4922611              & 145.0404806       & 1.65369513  & 143.3867854             \\
    (client: 10,                  & (normal)   &                   &             &                         &                   &             &                         \\
    (S/R byte length: 33.4KB/36B, & 10         & 11.11369          & 5.81784     & 5.29585                 & 3.355             & 3.17536     & 0.17964                 \\
    Protocol: WebSocket)          & (critical) &                   &             &                         &                   &             &                         \\
    13. priori.json\_msg          & 1-49       & 84.42516327       & 10.53019612 & 73.89496714             & 31.43365041       & 23.06905245 & 8.364597959             \\
    (client: 50,                  & (normal)   &                   &             &                         &                   &             &                         \\
...
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lllll}
Test case                               & var. value   & OWD forward (ms) & OWD return (ms) & RTT (ms) \\ \hline
14. Var. string\_msg, RCP-DTA           & 151B         & 8.0714           & None            & None     \\
(Protocol: TCP)                         & 80B          & 6.3943           & None            & None     \\
15. Var. robot data, DTA-Azure DT       & JointGripper & 26.3666          & 70.3221         & 96.688   \\
(Protocol: HTTP/HTTPS,                  & Elbow        & 24.4194          & 71.5992         & 96.0186  \\
msg type: json, byte length: 49B)       &              &                  &                 &          \\
16. Var. json\_msg, DTA-Azure DT        & 554B         & 20.92            & 82.16           & 103.08   \\
(Protocol: HTTP/HTTPS, data type: json) & 49B          & 23.78            & 78.63           & 102.41   \\
17. RCP-DTA-Azure DT                    & 151B         & 5.4137           & None            & None     \\
(Protocols: TCP, HTTP/HTTPS;            & 49B          & 26.3666          & 70.3221         & 96.6887  \\
