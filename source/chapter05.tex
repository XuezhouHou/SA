...
agent's communication. These tests involve passing messages through the \gls{ca} under 
...
parameters. In those tests, we first differentiate the delays of a packet with different 
