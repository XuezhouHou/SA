...
string length will be much shorter than the image length. As shown in fig.\ref{fig: priority-10clients-c}, 
...
As for the delay measurement of the designed external \gls{dta} system, tests for the 
upload and download are done separately, with different packet sizes as tuning parameters.
