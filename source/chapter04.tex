...
\subsection{Sequence diagrams of WebSocket based \gls{mas} architecture under two use cases and test 
...
is designed for a standard production process in real world.   


\begin{figure}[htb]
    \includegraphics[width=\textwidth]{figures/tests/usecase/SequenceUsecases.pdf}\hfill 
    \caption{\gls{uml} general use case diagram of the \gls{mas} architecture.} \label{fig: sequence-diagram}
\end{figure}
